...
namespace BlockSense.Utilities.UI
{
    public class ProfilePictureHandler
    {
        ...
        {
            _profilePicturesDirPath = @"C:\Users\d3str\Desktop\School\BlockSenseAPI\img";
        }

        public ProfilePictureHandler(UserInfo userInfo)
        {
            _userId = userInfo.UserId;
            _userPfpPath = Path.Combine(_profilePicturesDirPath, _userId + ".jpeg");
            _defaultPfpBitmap = new Bitmap(@"C:\Users\d3str\Desktop\School\BlockSense\src\BlockSense\Assets\defaultPfp.png");
        }
