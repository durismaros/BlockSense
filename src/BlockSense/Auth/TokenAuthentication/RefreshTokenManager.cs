...
namespace BlockSense.Client_Side.TokenAuthentication
{
    public class RefreshTokenManager
    {
        ...
        public RefreshToken? RetrieveToken()
        {
        ...
        private static void WriteDataToFile(RefreshToken token)
        {
        ...
        private static RefreshToken? ReadDataFromFile()
        {
