...
using BlockSense.Cryptography.General;
...
namespace BlockSense.Cryptography.Wallet.MnemonicManager
{
    class MnemonicManager
    {
        ...
        public static readonly string[] BIP39_WORDLIST = File.ReadAllLines(@"C:\Users\d3str\Desktop\School\BlockSense\src\BlockSense\Assets\bip39_english.txt");
        ...
        {
            byte[] salt = CryptographyUtilities.SecureRandomGenerator(SaltSize);
