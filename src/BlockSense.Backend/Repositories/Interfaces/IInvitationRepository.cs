...
namespace BlockSense.Backend.Repositories.Interfaces
{
    ...
    public interface IInvitationRepository
    {
        ...
        Task<string?> GetInviterUsernameByUser(uint userId, CancellationToken cancellationToken = default);
        ...
        Task<bool> IsActiveAsync(string invitationCode, CancellationToken cancellationToken = default);
